...
<template>
  <div>
    <VueRangedatePicker :presetRanges="{today: today(), yesterday: yesterday(), last7days: last7days(), last30days: last30days(), last90days: last90days()}" :i18n="EN"></VueRangedatePicker>
    <router-view/>
  </div>
</template>
